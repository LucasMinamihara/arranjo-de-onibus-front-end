...
function Informacoes(props) {
  ...
  return (
    <div className={classes.container}>
      ...
      <p>
        O arranjo pode ser pago tanto de forma física como de forma virtual por
        meio de pix.
      </p>
      <p>
        Assim que seu pagamento for efetuado, você receberá uma confirmação pelo
        e-mail e sempre que digitar o seu e-mail terá acesso a lista dos
